...
export type MediaAttachment = { url: string; name: string; mimeType: string; size?: number; duration?: number; publicId?: string };
...
export type Message = { id: string; senderId: string; receiverId: string; type: 'text' | 'image' | 'video' | 'document'; text?: string; attachment?: MediaAttachment; createdAt?: Timestamp; readBy?: string[]; isDeleted?: boolean };
